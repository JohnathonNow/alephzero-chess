...
impl PieceManager {
    fn new() -> Self {
        let map = HashMap::new();
        let mut me = Self { map };
        me.add_piecetype("pawn".into(), PieceType::new(is_pawn_move_legal));
        me.add_piecetype("knight".into(), PieceType::new(is_knight_move_legal));
        me.add_piecetype("bishop".into(), PieceType::new(is_bishop_move_legal));
        me.add_piecetype("rook".into(), PieceType::new(is_rook_move_legal));
        me.add_piecetype("queen".into(), PieceType::new(is_queen_move_legal));
        me.add_piecetype("king".into(), PieceType::new(is_king_move_legal));

        me
    }
    fn add_piecetype(&mut self, name: String, pt: PieceType) {
    ...
    fn build_piece(
        ...
        Some(Piece::new(self.map.get(piece)?.clone(), color, rank, file))
    }
}
